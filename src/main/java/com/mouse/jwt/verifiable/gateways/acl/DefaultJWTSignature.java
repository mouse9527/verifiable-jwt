...
public class DefaultJWTSignature implements JWTSignature {
    private final Signature signer;
    private final Signature verifier;

    public DefaultJWTSignature(KeyPair keyPair, String algorithm) throws InvalidKeyException, NoSuchAlgorithmException {
